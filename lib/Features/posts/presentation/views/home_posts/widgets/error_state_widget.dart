              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppColors.errorFieldColor.withValues(alpha: isDark ? 0.12 : 0.05),
                    shape: BoxShape.circle,
                  ),
                  child: Icon(
                    Icons.face,
                    size: 48,
                    color: AppColors.errorFieldColor.withValues(alpha: 0.7),
                  ),
                ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      'Try Again',
                      style: AppStyles.textStyle13.copyWith(color: Colors.white),
                    ),
                  ),
                ),
              ],

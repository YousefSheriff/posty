...
class LoginOptionsRowWidget extends StatelessWidget {
  ...
  const LoginOptionsRowWidget({super.key,});
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: false ? AppColors.appPrimaryColor : Colors.transparent,
                  border: Border.all(color: AppColors.appPrimaryColor, width: 1.5),
                  borderRadius: BorderRadius.circular(6),
                ),
                child: true ? const Icon(Icons.check, color: Colors.white, size: 14) : null,
              ),
            ),
          ],
        ),
